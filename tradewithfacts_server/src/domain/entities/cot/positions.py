...
class Positions:
    ...
    def __init__(self, long: int, short: int, change_in_long, change_in_short):
        ...
        """
        self.long: Final[int] = int(long)
        self.short: Final[int] = int(short)
        self.change_in_long: Final[int] = int(change_in_long)
        self.change_in_short: Final[int] = int(change_in_short)
    ...
    def percentage_change_in_net(self) -> float:
        ...
        return round(percentage_change_in_long - percentage_change_in_short, 1)
